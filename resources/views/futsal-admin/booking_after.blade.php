            ...
            <div class="tab-pane fade show active" id="tomorrow" role="tabpanel" aria-labelledby="tomorrow-tab">
                <div class="row gy-4 my-4">
                    @foreach ($time as $time)
                        <div class="col-3">
                            <button onclick="modalValue({{$time->id}})" class="btn" style="width: 100%" data-bs-toggle="modal" data-bs-target="#confirm-modal">
                    ...
                    @foreach ($bookings as $booked)
                        <div class="col-3">
                            ...
                            <input name='endTime' value="{{$i+1}}:00" type="hidden" /> --}}
                                <button onclick="modalValue({{strval($booked->id)}})" class="btn" style="width: 100%"  data-bs-toggle="modal" data-bs-target="#cancel-modal">
