    ...
    <ul class="nav nav-tabs d-flex justify-content-center my-4" id="myTab" role="tablist">
        <a class="tab_link" href="/futsals/{{$futsal->id}}/book-today">
            <li class="nav-item" role="presentation">
                <button class="nav-link custom__tab" id="today-tab" data-bs-toggle="tab" data-bs-target="#today" type="button" role="tab" aria-controls="today" aria-selected="true">Today</button>
              </li>
            </a>
            <a class="tab_link" href="/futsals/{{$futsal->id}}/book-tomorrow">
        <li class="nav-item" role="presentation">
          <button class="nav-link custom__tab" id="tomorrow-tab" data-bs-toggle="tab" data-bs-target="#tomorrow" type="button" role="tab" aria-controls="tomorrow" aria-selected="false">Tomorrow</button>
        </li>
            </a>
            <a class="tab_link" href="/futsals/{{$futsal->id}}/book-after">
        <li class="nav-item" role="presentation">
          <button class="nav-link active custom__tab" id="after-tab" data-bs-toggle="tab" data-bs-target="#after" type="button" role="tab" aria-controls="after" aria-selected="false">Day After</button>
        </li>
            </a>
      </ul>
      <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="after" role="tabpanel" aria-labelledby="after-tab">
