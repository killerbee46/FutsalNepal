...
@section('content')
    ...
    @endif
    @if (session('success'))
        <div class="alert alert-success" style="position: absolute; top:70px;left:0;right:0;text-align: center;z-index:5">
            {{ session('success') }}
        </div>
    @endif
    ...
    <div class="stats">
        <div class="container">
            <div class="row">
                ...
                <div class="col-4">
                    <p class="title">Futsals</p>
                    <p class="number">{{ $futsalCount }}</p>
                </div>
                <div class="col-4">
